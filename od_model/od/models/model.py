...
from od_model.utils.torch_utils import initialize_weights, fuse_conv_and_bn, model_info
import sys 
...
if __name__ == '__main__':
    ...
    x = torch.zeros(1, 3, 512, 512).float().to(device)

    model = Model(model_config='/home/insign2/work/flexible-yolov5/configs/model_resnet.yaml').eval().to(device)
