...
from od_model.utils.general import xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, resample_segments, \
    clean_str
from od_model.utils.torch_utils import torch_distributed_zero_first
...
def letterbox(im, new_shape=(640, 640), color=(114, 114, 114), auto=False, scaleFill=False, scaleup=True, stride=32):
    ...
    # Scale ratio (new / old)
    r1 = new_shape[0] / shape[0]
    r2 = new_shape[1] / shape[1]
    # print('r1,r2', r1,r2)
